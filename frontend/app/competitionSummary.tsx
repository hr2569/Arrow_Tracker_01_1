...
export default function CompetitionSummaryScreen() {
  ...
  const generatePdfHtml = (importCode?: string) => {
    ...
    // Import code section
    const importCodeSection = importCode ? `
      <div class="import-section">
        <h3>📋 Import Code</h3>
        <p style="font-size: 12px; color: #666; margin-bottom: 8px;">Enter this code in Score Keeping → Import to add your results</p>
        <div class="import-code">${importCode}</div>
      </div>
    ` : '';
    ...
    return `
      ...
      <body>
        ...
        <!-- Machine-readable import code for Score Keeping import -->
        <div style="margin-top: 30px; padding: 10px; background: #f8f8f8; border-radius: 4px; font-family: monospace; font-size: 8px; word-break: break-all; color: #999;">
          ATIMPORT:${importCode}:ENDATIMPORT
        </div>
      </body>
      </html>
    `;
