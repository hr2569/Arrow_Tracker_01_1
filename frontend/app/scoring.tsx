...
const styles = StyleSheet.create({
  ...
  zoomContainer: { overflow: 'hidden', marginBottom: 20 },
  horizontalScrollContent: { alignItems: 'center', justifyContent: 'center', minWidth: '100%' },
  verticalScrollContent: { alignItems: 'center', justifyContent: 'center', minHeight: '100%' },
