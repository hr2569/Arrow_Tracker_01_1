...
const styles = StyleSheet.create({
  ...
  zoomControls: { flexDirection: 'row', justifyContent: 'center', gap: 12, marginBottom: 12 },
  zoomButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#333', alignItems: 'center', justifyContent: 'center' },
  targetWrapper: { alignItems: 'center', marginBottom: 20, overflow: 'hidden' },
  zoomableContainer: { alignItems: 'center', justifyContent: 'center' },
