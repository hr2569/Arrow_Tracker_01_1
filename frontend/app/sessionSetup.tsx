...
export default function SessionSetupScreen() {
  ...
  const { sessionType, setSelectedBow, setSessionDistance, targetType, setTargetType, setManualMode } = useAppStore();
  ...
  const handleStartSession = () => {
    ...
    // Always use manual scoring mode
    setManualMode(true);
    router.push('/scoring');
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          {/* Scoring Method Selection - At Top */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Scoring Method</Text>
            
            <View style={styles.scoringMethodContainer}>
              <TouchableOpacity
                style={[
                  styles.scoringMethodCard,
                  scoringMethod === 'manual' && styles.scoringMethodCardSelected,
                ]}
                onPress={() => setScoringMethod('manual')}
                activeOpacity={0.8}
              >
                <View style={[
                  styles.scoringMethodIcon,
                  scoringMethod === 'manual' && styles.scoringMethodIconSelected,
                ]}>
                  <Ionicons
                    name="hand-left"
                    size={28}
                    color={scoringMethod === 'manual' ? '#fff' : '#8B0000'}
                  />
                </View>
                <Text style={[
                  styles.scoringMethodTitle,
                  scoringMethod === 'manual' && styles.scoringMethodTitleSelected,
                ]}>
                  Manual
                </Text>
                <Text style={styles.scoringMethodDesc}>
                  Tap target to score
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.scoringMethodCard,
                  scoringMethod === 'photo' && styles.scoringMethodCardSelected,
                ]}
                onPress={() => setScoringMethod('photo')}
                activeOpacity={0.8}
              >
                <View style={[
                  styles.scoringMethodIcon,
                  scoringMethod === 'photo' && styles.scoringMethodIconSelected,
                ]}>
                  <Ionicons
                    name="camera"
                    size={28}
                    color={scoringMethod === 'photo' ? '#fff' : '#8B0000'}
                  />
                </View>
                <Text style={[
                  styles.scoringMethodTitle,
                  scoringMethod === 'photo' && styles.scoringMethodTitleSelected,
                ]}>
                  Photo AI
                </Text>
                <Text style={styles.scoringMethodDesc}>
