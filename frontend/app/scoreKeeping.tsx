...
const styles = StyleSheet.create({
  ...
  exportCsvButtonDisabled: { backgroundColor: '#111', borderColor: '#333' },
  exportCsvButtonText: { fontSize: 14, fontWeight: 'bold', color: '#4CAF50' },
  exportCsvButtonTextDisabled: { color: '#666' },
  infoCard: {
    flexDirection: 'row',
