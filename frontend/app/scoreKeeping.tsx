...
const styles = StyleSheet.create({
  ...
  codeImportButtonText: { fontSize: 15, fontWeight: '600', color: '#FFD700' },
  modalOverlay: {
    flex: 1,
  ...
  codeModalTitle: { fontSize: 18, fontWeight: 'bold', color: '#fff' },
  codeModalDescription: { fontSize: 14, color: '#888', marginBottom: 16, lineHeight: 20 },
  codeInput: {
    backgroundColor: '#222',
    borderRadius: 12,
    padding: 16,
  ...
  codeImportSubmitDisabled: { backgroundColor: '#222' },
  codeImportSubmitText: { fontSize: 16, fontWeight: 'bold', color: '#000' },
  codeImportSubmitTextDisabled: { color: '#666' },
});
