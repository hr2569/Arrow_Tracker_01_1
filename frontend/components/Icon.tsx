...
const SettingsIcon = ({ size, color }: { size: number; color: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path 
      d="M20 12C20 11.4 19.96 10.8 19.9 10.24L22 8.5L20 5L17.36 6.08C16.52 5.38 15.54 4.84 14.48 4.5L14 2H10L9.52 4.5C8.46 4.84 7.48 5.38 6.64 6.08L4 5L2 8.5L4.1 10.24C4.04 10.8 4 11.4 4 12C4 12.6 4.04 13.2 4.1 13.76L2 15.5L4 19L6.64 17.92C7.48 18.62 8.46 19.16 9.52 19.5L10 22H14L14.48 19.5C15.54 19.16 16.52 18.62 17.36 17.92L20 19L22 15.5L19.9 13.76C19.96 13.2 20 12.6 20 12Z"
      stroke={color}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
